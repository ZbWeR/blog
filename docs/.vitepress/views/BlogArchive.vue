<template>
  <div
    class="mx-auto my-20 max-w-3xl px-4 pb-8 dark:divide-slate-200/20 sm:px-6 xl:max-w-5xl xl:px-0"
  >
    <!-- 标题 -->
    ...
    <!-- 主体 -->
    <ul class="mt-6 grid grid-cols-1 pt-6 lg:grid-cols-3 lg:gap-8">
      <!-- 所有文章 -->
      <div
      ...
      >
        ...
        <div class="mt-4" :class="flow ? 'columns-1 gap-8 lg:columns-2' : ''">
          <PostCard
